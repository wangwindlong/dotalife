...
package xyz.abcapp.dotalife.widget.jumpbean;
...
public final class JumpingBeans {
    ...
    /**
     * Create an instance of the {@link xyz.abcapp.dotalife.widget.jumpbean.JumpingBeans.Builder}
     * applied to the provided {@code TextView}.
     *
     * @param textView The TextView to apply the JumpingBeans to
     * @return the {@link xyz.abcapp.dotalife.widget.jumpbean.JumpingBeans.Builder}
     */
    ...
    /**
     * Builder class for {@link xyz.abcapp.dotalife.widget.jumpbean.JumpingBeans} objects.
     * <p/>
    ...
    public static class Builder {
         ...
         * resulting {@link xyz.abcapp.dotalife.widget.jumpbean.JumpingBeans}.
         *
         ...
         * {@link xyz.abcapp.dotalife.widget.jumpbean.JumpingBeans} instance.
         * <p/>
         * Remember to call the {@link #stopJumping()} method once you're done
         * using the JumpingBeans (that is, when you detach the TextView from
         * the view tree, you hide it, or the parent Activity/Fragment goes in
